...
## 1. The headline: the 1 Aug research tested the wrong vocabulary

The original conclusion ("no bottom-funnel search market") came from testing **UN/UNITAR/MUN
seed terms**. Those are indeed dead. But the market doesn't describe this product in UN
vocabulary — it describes it in **pre-college vocabulary**, and that market is real, cheap,
and actively bid on by direct competitors:

| Keyword (US) | Vol/mo | CPC | KD | Paid-click % | Who bids now |
|---|---|---|---|---|---|
| summer programs for high school students | 2,081 | $1.80 | 5 | 5% | NSLC, Summer Discovery |
| pre college programs | 1,281 | — | 27 | 6% | **NSLC's #1 paid keyword** |
| best summer programs for high school students | 1,000 | — | 6 | — | |
| law internships for high school students | 983 | — | 1 | 2% | NSLC (dedicated LP) |
| pre college summer programs | 746 | $1.80 | 34 | 3% | |
| programs for high school students | 545 | — | 3 | — | |
| university programs for high school students | 499 | — | 6 | — | |
| leadership programs for high school students | 450 | — | 0 | 5% | |
| college prep programs | 452 | — | 1 | 0% | |
| law programs for high school students | 350 | — | 0 | — | |
| exchange programs for high school students | 350 | — | 11 | — | |
| study abroad programs for high school students | 300 | — | 17 | 7% | |
| travel programs for high school students | 274 | — | 45 | — | |
| business summer programs for high school students | 285 | — | 1 | — | |
| youth leadership program | 234 | $1.70 | 0 | 2% | |
| summer abroad programs for high school students | 202 | — | 8 | 11% | |
| internship programs for high school students | 187 | — | 5 | — | |

Aggregate addressable US volume across the cluster: **~8–10k searches/mo**, CPCs $1.70–2.00,
keyword difficulty mostly 0–10, and measurable paid-click share on the money terms.
This is a real (small) demand-capture market that the original plan missed.

## 2. Competitor paid footprints (Ahrefs paid index, 1 Jul 2026)

| Competitor | Paid activity | What to learn |
|---|---|---|
| **nslcleaders.org** | 205 paid keywords on homepage alone (~$900/mo est. traffic value) + per-vertical LPs (law, business, engineering, nursing, aerospace, vet) | The model to copy: **one LP per interest vertical**, each bidding "<vertical> for high school students". Their top keyword is `pre college programs` (1,400/mo). |
| **summerdiscovery.com** | Dedicated `/lp/` pages per campus and vertical; brand + `ucla high school summer program` etc. | Campus-brand association sells. Ureka's equivalent asset is **UN/Palais des Nations** — "UN youth program" has no volume, but "…at the United Nations, Geneva" belongs in ad copy, not keywords. |
| **crimsoneducation.org** | Heavy global spend; bids competitor brand `princeton review` (17k/mo); country-specific campaign LPs; explicit **parent-targeted LPs** ("parents-multiply-odds…") | Parents are the search audience worth paying for. Country-specific landing pages, not one global page. |
| **envisionexperience.com** | Small; vet-academy niche terms only | Niche-vertical LPs can win tiny terms cheaply. |
| **oxfordroyale.com / immerse.education** | **Zero Google paid detected** (global and GB) | The two most Ureka-like products skip Google Search entirely — they prospect on social. Half-confirms the demand-gen thesis; doesn't kill Search, but caps its ceiling. |

## 3. Gulf markets (confirms strategy doc §5)

**UAE:** `summer programs for high school students` 98/mo ($0.80) · `winter camp dubai` 144/mo
($0.70) · `leadership program dubai` 68/mo ($2.50) · `summer camps dubai` 271/mo (wrong intent —
kids' day camps; negative). A ~$8–10/day campaign is feasible; nothing more.
**Qatar:** confirmed ~zero (`summer programs for high school students` 30/mo, rest ≤10).
**No Search campaign for Qatar** — institutional outreach only, as planned.

## 4. Honest caveats

1. **Season mismatch.** The big terms say "summer"; IPP's Geneva week is 29 Nov–5 Dec.
   Bidding summer terms in Aug–Sept catches families planning *summer 2027* — usable as
   2027 pipeline, not for the 4 Oct deadline. The terms that fit the November cohort are the
   non-seasonal ones: `leadership programs…`, `pre college programs`, `study abroad…`,
   `exchange programs…`, `youth leadership program` (~3,500/mo aggregate US).
2. **"High school students" = mostly minors.** The searcher is usually the parent — good
   (they pay) — but ad copy targets parents/18+, per audit A4.
3. **Term-time clash (A10) survives.** Search can deliver the lead; the page must still answer
   "miss a week of school in December?" head-on.
4. **CPC data is directional** at these volumes; expect real CPCs 1.5–2× Ahrefs.

## 5. Revised Search structure (replaces strategy §3 tier table)

| Campaign | Geo | Ad group themes (phrase + exact only) | LP | Daily |
|---|---|---|---|---|
| **IPP – Leadership/Pre-college (non-seasonal)** | US | leadership programs for hs / youth leadership / pre college programs / programs for hs students | `/ipp/` | **$25** |
