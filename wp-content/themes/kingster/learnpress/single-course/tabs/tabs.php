...
<div id="learn-press-course-tabs" class="course-tabs">
	...
	<?php // goodlayers ?>
    <div class="kingster-learn-press-nav-tabs-wrap">
	    <ul class="learn-press-nav-tabs course-nav-tabs" data-tabs="<?php echo count( $tabs ); ?>">
			<?php foreach ( $tabs as $key => $tab ) : ?>
				...
				<li class="<?php echo esc_attr(implode( ' ', $classes )); ?>">
					<label for="tab-<?php echo esc_attr($key); ?>-input"><?php echo $tab['title']; ?></label>
				</li>
			<?php endforeach; ?>

		</ul>
	    <div class="kingster-tab-slidebar" >
	    	<div class="kingster-tab-slidebar-border"></div>
	    </div>
	</div>

	<div class="course-tab-panels">
		<?php foreach ( $tabs as $key => $tab ) : ?>
			<div class="course-tab-panel-<?php echo esc_attr( $key ); ?> course-tab-panel clearfix"
