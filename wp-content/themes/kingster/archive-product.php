 ...
 */
	...
	$sidebar_type = kingster_get_option('general', 'woocommerce-archive-sidebar', 'none');
	$sidebar_left = kingster_get_option('general', 'woocommerce-archive-sidebar-left');
	$sidebar_right = kingster_get_option('general', 'woocommerce-archive-sidebar-right');		
